...
class CalculatorTest extends PHPUnit_Framework_TestCase{
  ...
  public function testAdd(){
      ...
      $this->assertEquals(1, $sum); //check if 2+3+4+5 is equal to 14
  }
  ...
  public function testSubtract(){
      ...
      $this->assertEquals(0, $difference); //check if 5 - 2 is equal to 3
  }
  ...
  public function testMultiply(){
      ...
      $this->assertEquals(190, $product); //check if 1*3*5*6 is equal to 90
  }
